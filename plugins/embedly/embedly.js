  ...
  var a = (function b(c, d, e) {
  ...
  })(
    {
      ...
      2: [
        ...
        { "./browser.js": 4, "./utils.js": 30, conf: "conf" },
      ],
      3: [
        function (a, b, c) {
          var d = a("./utils"),
      ...
      4: [
        ...
        { "./dom.js": 7, "./urlparse.js": 29, "./utils.js": 30, conf: "conf" },
      ],
      5: [
        function (a, b, c) {
          var d = !1,
      ...
      6: [
        ...
        { "./iframes/comms.js": 13, "./utils.js": 30 },
      ],
      7: [
        function (a, b, c) {
          var d = a("./utils.js"),
      ...
      19: [
        function (a, b, c) {
          ...
          (h.getUID = function () {
            ...
            return 32 !== b.u.length
              ? h.setUID()
              : d.getTimestamp() - c > 15552e6
              ? h.setUID(b.u)
              : b.u;
          }),
            (h.setUID = function (a) {
              var b = { u: d.isNone(a) ? d.getUUID() : a, t: d.getTimestamp() },
                c = encodeURIComponent(e.createQuery(b));
              return (
                f.cookie.set(h.COOKIE_NAME, c, 365),
                (c = f.cookie.get(h.COOKIE_NAME)),
                d.isNone(c)
                  ? 0
                  : ((b = e.parseQuery(decodeURIComponent(c))), b.u)
              );
            }),
            (h.uid = h.getUID()),
            (h.release = function () {
              var a = h._queue;
              (h._queue = []),
                f.console.log("log.release", a),
                h.hub.notify("xcomm.log.event", { events: a });
            }),
            (h.queue = function (a) {
              clearTimeout(h.timeout),
                h._queue.push(a),
            ...
            (h.event = function (a) {
              var b = { uid: h.uid, sid: h.sid, t: d.getTimestamp() };
            ...
            (h.comms = function () {
              return h.connected
                ...
                ? h.connecting
                  ? !1
                  : ((h.connecting = !0),
                    h.hub.one("xcomm.ready", function () {
                      (h.connected = !0), h.release();
                    }),
                    void g.connect(h.hub, { name: h.name }))
                : !1;
            }),
      ...
      20: [
        function (a, b, c) {
          var d = a("./browser.js"),
            ...
            f = a("./dom.js"),
            g = { _data: null };
          (g.COOKIE_NAME = "em_p_uid"),
            (g.format = function (a) {
              return a && e.isObject(a)
                ? e
                    .map(a, function (a, b) {
                      return b + ":" + a;
                    })
            ...
            (g.get = function () {
              ...
              return c === !1
                ? g.set()
                : e.getTimestamp() - c > 15552e6
                ? g.set({ u: b.u, l: b.l })
                : b;
            }),
            (g.set = function (a) {
              var b = { u: e.getUUID(), t: e.getTimestamp(), l: 0 };
              a && (b = e.extend(b, a));
              var c = g.format(b);
              return (
                d.cookie.set(
                ...
                (c = d.cookie.get(g.COOKIE_NAME)),
                e.isNone(c) ? null : g.parse(c)
              );
            }),
            (g.update = function (a) {
              var b = g.get();
            ...
            (g.data = function () {
              ...
              var a = {
                ...
                b = g.get();
              return (
                b ? ((a.muu = b.u), (a.mut = b.t), (a.mul = b.l)) : (a.muu = 0),
                (g._data = a),
                g.update({ l: e.getTimestamp() }),
                g._data
              );
            }),
            (g.send = function (a, b) {
        ...
        { "./browser.js": 4, "./dom.js": 7, "./utils.js": 30 },
      ],
      21: [
        function (a, b, c) {
          var d = a("./dom.js"),
      ...
      27: [
        ...
        { "./urlparse.js": 29, "./utils.js": 30, conf: "conf" },
      ],
      28: [
        function (a, b, c) {
          var d = a("./utils.js"),
      ...
      32: [
        function (a, b, c) {
          ...
          var B = function (a, b, c) {
            ...
            F = function (a) {
              ...
              b.one("media.ready", function (a) {
                (b.url = a.url),
                  b.ready(),
                  w.on("viewable", b.elem, function () {
                    b.send("media.view");
                  }),
                  v.notify("media.recommend.add", b),
                  z.media.push(b),
                  a.controllable && v.notify("media.player.init", b),
                  v.notify("media.ready", b);
              }),
            ...
            H = function (a, b) {
              ...
              if (f.isString(b)) {
                ...
                f.each(z.media, function (d) {
                  d.elem === a &&
                    ((c = !0), v.notify("media.recommend." + b, d, d.elem));
                }),
                  c || v.notify("media.recommend." + b, null, a);
              } else
                f.isObject(b) &&
                  v.notify("media.recommend.options", a, b, z.media);
              n.look();
            },
            I = function (a) {
          ...
          v.on("found", function (a) {
            a.cards &&
              a.cards.length &&
              d.cards.multi(a.cards, y.defaults.cards, v),
              a.buttons &&
                a.buttons.length &&
          ...
          v.on("pinterest.log", function () {
            ...
            i.script(
              "https://log.pinterest.com/?" + m.createQuery(a),
              function () {
          ...
          var L = function (a, b) {
            ...
            N = function () {
              h.detachEvent(window, "message", A),
                n.stop(),
                v.clear(),
          ...
          t.allowed(window.location.toString())
            ? P()
            : ((window.embedly = function () {}),
              f.each(
